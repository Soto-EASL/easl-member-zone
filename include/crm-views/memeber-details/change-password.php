...
?>
<div class="easl-mz-password-change-wrap">
    <div class="easl-mz-password-change-inner">
        ...
        <div class="mzms-fields-row easl-row easl-row-col-2" style="margin-bottom: 0;">
            <div class="easl-col">
                <div class="easl-col-inner mzms-fields-con mzms-change-password-submit-wrap">
                    <a class="mzms-button mzms-change-password-submit" href="#">Go ahead</a>
                </div>
            </div>
            <div class="easl-col">
                <div class="easl-col-inner mzms-fields-con mzms-change-password-cancel-wrap">
                    <a class="mzms-button mzms-change-password-cancel" href="#">Cancel</a>
                </div>
            </div>
        </div>
