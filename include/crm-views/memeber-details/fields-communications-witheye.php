...
<div class="mzms-fields-row">
    <div class="mzms-fields-con">
        <label for="mzms_email">Email</label>
...
<div class="mzms-fields-row easl-row easl-row-col-2">
    <div class="easl-col">
        <div class="easl-col-inner mzms-fields-con">
            <label for="mzms_telephone">Phone (work)</label>
    ...
    <div class="easl-col">
        <div class="easl-col-inner mzms-fields-con">
            <label for="mzms_mobile">Mobile</label>
            <div class="mzms-field-wrap mzms-field-has-privacy mzms-privacy-enabled">
...
<div class="mzms-fields-row easl-row easl-row-col-2">
    ...
    <div class="easl-col">
        <div class="easl-col-inner mzms-fields-con">
            <label for="mzms_mobile">Other Phone</label>
            <div class="mzms-field-wrap mzms-field-has-privacy mzms-privacy-enabled">
    ...
    <div class="easl-col">
        <div class="easl-col-inner mzms-fields-con">
            <div class="mzms-field-wrap">
                <label for="do_not_call" class="easl-custom-checkbox">
...
<div class="mzms-fields-row easl-row easl-row-col-2">
    ...
    <div class="easl-col">
        <div class="easl-col-inner mzms-fields-con">
            <label for="dotb_assistant_email">Assistant email</label>
            <div class="mzms-field-wrap">
...
<div class="mzms-fields-row easl-row easl-row-col-2">
    <div class="easl-col">
        <div class="easl-col-inner mzms-fields-con">
            <label for="assistant_phone">Assistant telephone</label>
            <div class="mzms-field-wrap">
