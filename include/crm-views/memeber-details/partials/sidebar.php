        ...
        <div class="mzms-sbitem">
            <div class="mzms-icon-cta">
                <div class="easl-icon-cta-inner">
                    <a class="easl-icon-cta-link" href="/member-directory/">
                        <div class="easl-icon-cta-icon">
                            <img class="easl-icon-cta-icon-normal" src="/wp-content/uploads/2019/08/icon-doc2-blue.png" alt="">
                            <img class="easl-icon-cta-icon-hover" src="/wp-content/uploads/2019/08/icon-doc2-white.png" alt="">
                        </div>
